...
{
	struct SafetyCheckerCropSize : public Json::json_object_base
	{
	...
	struct SafetyCheckerSize : public Json::json_object_base
	{
	...
	struct SafetyCheckerOptions : public Json::json_object_base
	{
